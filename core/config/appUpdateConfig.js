...
export default {
    ...
    getServerNo: (version, isPrompt = false, callback) => {
        ...
        $http.get("/api/v1/app/common/version/now", httpData, {
            isPrompt: isPrompt
        }).then(res => {
             ...
             */
						let { downloadUrl, versionCode, versionName } = res.data
            if (res.code === 200 && downloadUrl && version.versionName != versionName && version.versionCode != versionCode) {
