			...
			<view class="form-area">
				<u--form :model="registerForm" :rules="registerRules" ref="registerRef">
					<u-form-item prop="account">
						<u--input v-model="registerForm.account" :placeholder="$t('login.placeholderPhoneAndEmail')" shape="circle"
							:placeholderStyle="placeholderStyle" prefixIcon="account-fill"
							:prefixIconStyle="prefixIconStyle"></u--input>
					</u-form-item>
					<u-form-item prop="code">
						<!-- #ifndef APP-NVUE -->
						<u-input v-model="registerForm.code" :placeholder="$t('login.placeholderCode')" shape="circle" :placeholderStyle="placeholderStyle"
					...
					<u-form-item prop="password">
						<u--input v-model="registerForm.password" :placeholder="$t('login.placeholderPassword')" shape="circle"
							:placeholderStyle="placeholderStyle" prefixIcon="lock-fill" :prefixIconStyle="prefixIconStyle"
							password></u--input>
					</u-form-item>
					<u-form-item prop="confirmPassword">
						<u--input v-model="registerForm.confirmPassword" :placeholder="$t('login.placeholderConfirmPwd')" shape="circle"
							:placeholderStyle="placeholderStyle" prefixIcon="lock-fill" :prefixIconStyle="prefixIconStyle"
							password></u--input>
					</u-form-item>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getCode() {
				if (this.registerForm.account && (uni.$u.test.mobile(this.registerForm.account) || uni.$u.test.email(this
