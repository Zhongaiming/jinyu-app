...
let commonMixin = {
	...
	methods: {
		getExcludeNavbarHeight() { 
			...
			this.excludeNavbarHeight = this.screenHeight - globalConfig.navigatorHeight - this.JinYuStatusBarHeight - 1
		...
		getExcludeNavbarAndTabbarHeight() { 
			...
			this.excludeNavbarHeightAndTabbarHeight = this.screenHeight - globalConfig.navigatorHeight - this
				.JinYuStatusBarHeight - globalConfig.tabBar.tabBarHeight
	...
	onShow() {
		...
		// 	'\n可使用窗口screenHeight: ', this.screenHeight, '\n顶部状态栏JinYuStatusBarHeight: ', this.JinYuStatusBarHeight, )
